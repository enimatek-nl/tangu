...
proc loginController(scope: Tscope, lifecycle: Tlifecycle) {.async.} =
...
proc viewTodosController(scope: Tscope, lifecycle: Tlifecycle) {.async.} =
...
proc addTodoController(scope: Tscope, lifecycle: Tlifecycle) {.async.} =
...
proc cameraTodoController(scope: Tscope, lifecycle: Tlifecycle) {.async.} =
...
let tng = newTangu(
    @[
        ...
        tngRouter()],
    @[
        newController("login", staticRead("login.html"), loginController),
        newController("viewTodos", staticRead("view.html"), viewTodosController),
        newController("addTodo", staticRead("add.html"), addTodoController),
        newController("cameraTodo", staticRead("camera.html"), cameraTodoController)],
    @[
